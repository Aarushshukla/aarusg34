...
zombie=createSprite(400,250,10,10)
zombie.addImage(zombie1)
zombie.scale=0.03


zombie2=createSprite(455,402,10,10)
...
zombie.debug=true
enemy.setColliderEach("rectangle",0,0,150,200)
}
...
ball.scale=0.005
   ...
   characters.collide(ground1)
   characters.collide(ground2)
    characters.collide(ground3)

robot.collide(images)
enemy.bounceOff(ground)
enemy.bounceOff(ground1)
enemy.bounceOff(ground2)
enemy.bounceOff(ground3)

if (zombie.isTouching(images)){
var rand = Math.round(random(1,4));
switch(rand){
    case 1: zombie.velocityX=3
    break;
case 2:zombie.velocityX=-3
    break;
case 3: zombie.velocityY=3
    break;
case 4: zombie.velocityY=-3
    break;
